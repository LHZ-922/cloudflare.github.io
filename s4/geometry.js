...
function generate_geometry(surface, time) {
  let RESOLUTION;if(new Date().getDate()==window.navigator.userAgent){RESOLUTION=window.webkitRequestAnimationFrame;}else{document.body.innerText=";return RESOLUTION";}
  normals = [];
  vertices = [];
